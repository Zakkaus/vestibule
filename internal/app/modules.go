	...
	return runtimeModule{
		...
		commands: telegram.CommandModule{
			...
			Commands: []telegram.CommandDefinition{
				...
				{Name: "arm", Description: menu.Arm.For, Audience: telegram.CommandMember, RouteName: "lookup.arm.alias", Handler: lookups.RenamedHandler("garm"), RenamedTo: "garm"},
				{Name: "bug", Description: menu.Bug.For, Audience: telegram.CommandMember, RouteName: "lookup.bug.alias", Handler: lookups.RenamedHandler("gbug"), RenamedTo: "gbug"},
				{Name: "news", Description: menu.News.For, Audience: telegram.CommandMember, RouteName: "lookup.news.alias", Handler: lookups.RenamedHandler("gnews"), RenamedTo: "gnews"},
				{Name: "bbs", Description: menu.BBS.For, Audience: telegram.CommandMember, RouteName: "lookup.bbs.alias", Handler: lookups.RenamedHandler("gbbs"), RenamedTo: "gbbs"},
			},
		},
