...
func cloneGroupOverrides(value GroupOverrides) GroupOverrides {
	...
	out.GentooLookupsEnabled = clonePtr(value.GentooLookupsEnabled)
	out.LinuxLookupsEnabled = clonePtr(value.LinuxLookupsEnabled)
...
func compactGroupOverrides(value GroupOverrides, baseline GroupBaseline) GroupOverrides {
	...
	value.GentooLookupsEnabled = omitBaseline(value.GentooLookupsEnabled, baseline.GentooLookupsEnabled.Value)
	value.LinuxLookupsEnabled = omitBaseline(value.LinuxLookupsEnabled, baseline.LinuxLookupsEnabled.Value)
