...
bot.renamed_command=1:s
bot.daily.report=1:s,2:s,3:s,4:s,5:s,6:d
...
bot.registration.start_identity=1:d
feed.git_hub.author=1:s
feed.git_hub.branch=1:s
feed.git_hub.commit=1:s,2:s,3:s,4:s,5:s,6:s
feed.git_hub.issue_opened=1:s,2:s,3:d,4:s,5:s
feed.git_hub.pull_opened=1:s,2:s,3:d,4:s,5:s
...
panel.settings.error.limit_exceeded=1:s,2:d,3:d
...
panel.settings.screen.runtime=1:d,2:s,3:s,4:s,5:s,6:s,7:s,8:s,9:s,10:s,11:s
