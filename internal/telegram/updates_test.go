...
func expectedMemberCommands(language i18n.Lang) []telego.BotCommand {
	...
	return []telego.BotCommand{
		...
		{Command: "gpkg", Description: menu.Pkg.For(language)},
		{Command: "guse", Description: menu.Use.For(language)},
		{Command: "garm", Description: menu.Arm.For(language)},
		{Command: "gbug", Description: menu.Bug.For(language)},
		{Command: "gnews", Description: menu.News.For(language)},
		{Command: "gbbs", Description: menu.BBS.For(language)},
