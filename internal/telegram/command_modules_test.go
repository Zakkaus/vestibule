...
func testCommandModules(t *testing.T) CommandModules {
	...
	modules, err := NewCommandModules(CommandModule{
		...
		Commands: []CommandDefinition{
			...
			{Name: "gpkg", Description: member.Pkg.For, Audience: CommandMember, RouteName: "lookup.pkg", Handler: testCommandHandler},
			{Name: "guse", Description: member.Use.For, Audience: CommandMember, RouteName: "lookup.use", Handler: testCommandHandler},
			{Name: "garm", Description: member.Arm.For, Audience: CommandMember, RouteName: "lookup.arm", Handler: testCommandHandler},
			{Name: "gbug", Description: member.Bug.For, Audience: CommandMember, RouteName: "lookup.bug", Handler: testCommandHandler},
			{Name: "gnews", Description: member.News.For, Audience: CommandMember, RouteName: "lookup.news", Handler: testCommandHandler},
			{Name: "gbbs", Description: member.BBS.For, Audience: CommandMember, RouteName: "lookup.bbs", Handler: testCommandHandler},
