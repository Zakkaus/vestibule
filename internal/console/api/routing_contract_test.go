...
func routingContractRequests(h routingContractHarness) []routingRequest {
	...
	return []routingRequest{
		...
		{name: "feeds replace", method: http.MethodPut, path: chatPath + "/feeds", body: `{"expected_revision":0,"lang":"","interval_seconds":300,"bugs":false,"bugzilla_base":"","news":false,"bug_product":"","bug_component":"","silent_bugs":false,"github_repos":[]}`, contentType: "application/json", cookies: h.managerCookies, csrf: h.managerGrant.CSRFToken, want: http.StatusOK},
