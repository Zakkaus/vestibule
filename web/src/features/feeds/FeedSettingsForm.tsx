  ...
  return (
    <form data-feeds-form data-save-state={saving ? "submitting" : "idle"} aria-busy={saving || undefined} noValidate onSubmit={onSubmit}>
      <section data-slot="card" data-feeds-section="feed" aria-labelledby="feeds-form-title">
        ...
        <TextSetting field="bugzilla_base" controlID="feeds-bugzilla-base" labelKey="feeds.fields.bugzillaBase.label" descriptionKey="feeds.fields.bugzillaBase.description" setting={settings.feed.bugzillaBase} value={draft.bugzilla_base} errorKey={errors.bugzilla_base} saving={saving} onChange={(value) => update("bugzilla_base", value)} />
